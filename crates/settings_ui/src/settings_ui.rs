...
fn init_renderers(cx: &mut App) {
    cx.default_global::<SettingFieldRenderer>()
        ...
        .add_basic_renderer::<settings::GitPanelCommitEditorPosition>(render_dropdown)
        .add_basic_renderer::<settings::GitPanelCommitButtonStyle>(render_dropdown)
        .add_basic_renderer::<settings::GitPanelRepositoryFooterPosition>(render_dropdown)
        .add_basic_renderer::<settings::GitPanelChangeSectionStyle>(render_dropdown)
