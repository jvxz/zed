use crate::{
    ...
    ConflictsTheirs, ConflictsTheirsMarker, ContextMenuPlacement, CursorAnimationState,
    ...
    LineHighlight, LineUp, MAX_LINE_LEN, SmoothCursorStyle,
                        ...
                        && EditorSettings::get_global(cx).mouse_wheel_zoom
                    {
                        ...
                        editor.update(cx, |editor, cx| {
                            ...
                            if scroll_position != base_scroll_position {
                                let scroll_behavior = if is_precise || !smooth_scroll_enabled {
